# Generated by Django 3.0.3 on 2021-03-10 15:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='profile',
            name='disliked_songs',
            field=models.ManyToManyField(related_name='profile_disliked', to='mainsite.Song'),
        ),
        migrations.AddField(
            model_name='profile',
            name='favorite_playlists',
            field=models.ManyToManyField(related_name='profile_favorite_playlists', to='mainsite.Playlist'),
        ),
        migrations.AddField(
            model_name='profile',
            name='following',
            field=models.ManyToManyField(related_name='profile_following', to='mainsite.Profile'),
        ),
        migrations.AddField(
            model_name='profile',
            name='liked_songs',
            field=models.ManyToManyField(related_name='profile_liked', to='mainsite.Song'),
        ),
        migrations.AddField(
            model_name='playlist',
            name='owner',
        ...
        migrations.AddField(
            model_name='playlist',
            name='songs',
            field=models.ManyToManyField(to='mainsite.Song'),
        ),
    ]
